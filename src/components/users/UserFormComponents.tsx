    ...
    >
      ...
      <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
        ...
        <FormControl fullWidth size="small">
          ...
          <Select
            value={access.roleId === 2 ? 'Manager' : 'Employee'}
      ...
      >
          ...
          control={
            <Checkbox
              ...
              sx={{
                ...
                '&.Mui-disabled': { color: isManagerOrAdmin ? '#FF6B35' : undefined },
              }}
              inputProps={{
        ...
        {PERMISSION_MODULES.map((module) => {
          const moduleAllSelected = isManagerOrAdmin || module.permissions.every(
            perm => access.modulePermissions[module.id]?.includes(perm)
          );
          const moduleSomeSelected = !isManagerOrAdmin && module.permissions.some(
            perm => access.modulePermissions[module.id]?.includes(perm)
          );
                ...
                {module.permissions.map((perm) => (
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        size="small"
                        checked={isManagerOrAdmin || access.modulePermissions[module.id]?.includes(perm) || false}
