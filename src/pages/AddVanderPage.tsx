...
const AddVanderPage: React.FC = () => {
  ...
  const handleSubmit = () => {
    ...
    const existingVanders = JSON.parse(
      localStorage.getItem('vanders') || '[]'
    );
    ...
    localStorage.setItem(
      'vanders',
      JSON.stringify([...existingVanders, newVander])
    );
