...
import { getPurchaseReturnsApi, getCompaniesApi } from '../../../generated/api/client';
  ...
  const handleDownloadPdf = useCallback(async (id: string) => {
    try {
      ...
      const [returnRes, companiesRes] = await Promise.all([
        purchaseReturnsApi.getById(Number(id)),
      ...
      await downloadInvoicePdf({
        ...
        documentNumber: ret.returnNumber || ret.billNumber || String(id),
        date: ret.date || '',
        company: {
        ...
        party: {
          name: ret.vendor?.partyName || 'Vendor',
        },
        lines,
        discountPercent,
                  ...
                  <TableRow key={returnItem.id} hover>
                    ...
                    <TableCell>
                      ...
                      <IconButton
                        ...
                        sx={{ color: '#6366F1' }}
                        aria-label={`Download return ${returnItem.billNumber} as PDF`}
                      >
